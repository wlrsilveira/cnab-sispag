...
/**
 * Códigos de erro do Banco do Brasil — API Pagamentos em Lote.
 *
 * Categorias:
 *   1–349   Validação de lançamentos (física + prévia) e retorno de processamento
 *   419–448 Erros específicos do PIX (SED/Bacen)
 *   999     Erro genérico — consultar o banco
 *   1000+   Códigos de devolução de lançamentos PIX
 */
return [
    // ── 1) Erros específicos do PIX (SED/Bacen) ──────────────────────────
    ...
    423 => 'Número da conta transacional encerrada no PSP do Recebedor',
    ...
    448 => 'Pix não efetivado',

    // ── 2) Validação de lançamentos (física + prévia) ─────────────────────
    ...
    8 => 'Valor do pagamento não é numérico. Informe apenas números.',
    ...
    12 => 'Nenhum dos campos Finalidade DOC ou Finalidade TED foram informados. Informe um dos campos.',
    ...
    91 => 'Valor de outras deduções não informado.',
    92 => 'Valor de outros acréscimos não informado.',
    ...
    117 => 'Nº de identificação do contribuinte DARF inválido. Informe um número válido.',
    ...
    127 => 'Código de barras incompatível com a modalidade de pagamento.',
    ...
    222 => 'Tipo/Número de Inscrição do Favorecido Inválido. CPF ou CNPJ do favorecido inválido.',
    ...
    277 => 'Tipo do benefício não permite empréstimo.',
    278 => 'Benefício cessado/suspenso.',
    279 => 'Benefício possui representante legal.',
    280 => 'Benefício é do tipo PA (Pensão alimentícia).',
    281 => 'Quantidade de contratos permitida excedida.',
    282 => 'Benefício não pertence ao Banco informado.',
    ...
    316 => 'Não averbação de contrato - quantidade de parcelas/competências informadas é diferente da calculada.',
    ...
    325 => 'Divergência entre o primeiro e último nome do beneficiário.',
    ...
    339 => 'Tipo de transação não é suportado/autorizado na conta.',
    340 => 'CPF/CNPJ do usuário recebedor não é consistente com o titular da conta.',
    ...
    349 => 'Bloqueado por limite excedido.',

    // ── Erro genérico ─────────────────────────────────────────────────────
    999 => 'Consultar o Banco para detalhar o erro.',

    // ── 3) Códigos de devolução de lançamentos PIX ────────────────────────
    1000 => 'Devolução PIX: Outros.',
    1010 => 'Devolução PIX: Pix não aceito pelo recebedor.',
    1020 => 'Devolução PIX: Pix realizado em duplicidade.',
    1030 => 'Devolução PIX: Devolução por suspeita de fraude.',
    1040 => 'Devolução PIX: Desistência do pagador.',
    1050 => 'Devolução PIX: Disputa entre usuários.',
    1060 => 'Devolução PIX: Ordem de pagamento não justificada.',
    1070 => 'Devolução PIX: Devolução após problemas técnicos.',
    1080 => 'Devolução PIX: Devolução após a solicitação de investigação.',
    1090 => 'Devolução PIX: Recebedor não autorizado pelo pagador.',
    1100 => 'Devolução PIX: Recebedor impedido pelo pagador.',
    1110 => 'Devolução PIX: Devolução - Instituição do recebedor.',
    1120 => 'Devolução PIX: Devolução por erro no saque Pix.',
];
