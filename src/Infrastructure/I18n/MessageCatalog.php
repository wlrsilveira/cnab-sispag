...
final class MessageCatalog
{
    ...
    private const MESSAGES = [
        ...
        'validation.transfer_invalid_itau_agency_account' => 'Linha :line: agência/conta Itaú inválida no segmento A. Formato Nota 11: 0 + agência(4) + branco + 000000 + conta(6) + branco + DAC.',
        'validation.transfer_invalid_ted_agency_account' => 'Linha :line: agência/conta TED inválida no segmento A. Formato Nota 11: agência(5) + branco + conta(12) + branco + DAC.',
    ];
